...
export class feedbackinfoHtml extends React.Component {
  handleMessage(event) {
  ...
  render() {
    return (
      <div className="col-6 bg-light mx-auto text-center">
        <h1>FeedBack Form</h1>
        <p>Please give feedback by clicking following button</p>
        <button
        ...
        <div
          ...
          aria-hidden="true"
        >
          <div className="modal-dialog" role="document" style={{ height: 200 }}>
            <div
